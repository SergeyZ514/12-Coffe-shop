  ...
  return (
    <>
      <section className='main-content'>
        ...
        <div className='main-content__logo beans-logo beans-logo_white'>
          <svg
            width='30'
            height='29'
            viewBox='0 0 30 29'
        ...
        <h2 className='main-content__secondary-title'>
          We makes every day full of energy and taste
        </h2>
        <h3 className='main-content__secondary-title main-content__secondary-title_shadow'>
          Want to try our beans?
        </h3>
        <button className='main-content__more-btn'>More</button>
      </section>
      <section className='about-us'>
        <h2 className='secondary-title'>About Us</h2>
        <div className='about-us__logo beans-logo'>
          <svg
            width='30'
            height='29'
            viewBox='0 0 30 29'
