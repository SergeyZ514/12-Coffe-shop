import "./goodsPageContent.scss";
import cup from "../../resources/img/cup.jpg";

function GoodsPageContent() {
  return (
    <section className='goods-content'>
      <div className='goods-content__row'>
        <div className='goods-content__item'>
          <img src={cup} alt='A cup of coffee' />
        </div>
        <div className='goods-content__item'>
          <h2 className='secondary-title'>About our goods</h2>
          <div className='goods-content__logo beans-logo'>
            <svg
              width='30'
              height='29'
              viewBox='0 0 30 29'
          ...
          <p className='goods-content__text'>
...
export default GoodsPageContent;
